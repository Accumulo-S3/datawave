...
public class DeletingIteratorV2 extends ServerWrappingIterator {
  ...
  public DeletingIteratorV2(DeletingIteratorV2 other, IteratorEnvironment env) {
    super(other.source.deepCopy(env));
    propagateDeletes = other.propagateDeletes;
  }

  public DeletingIteratorV2(SortedKeyValueIterator<Key,Value> iterator, boolean propagateDeletes) {
    super(iterator);
  ...
  public static Behavior getBehavior(AccumuloConfiguration conf) {
    return DeletingIteratorV2.Behavior
