...
//            helper.setup();
            ...
            tl = TabletLocator.getLocator(clientCtx, tableId);
        }
        Iterator<List<ScannerChunk>> chunkIter = Iterators.transform(getQueryDataIterator(), new PushdownFunction(tl, config, settings, tableId.canonical()));
