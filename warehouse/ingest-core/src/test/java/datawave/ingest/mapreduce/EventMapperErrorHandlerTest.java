...
public class EventMapperErrorHandlerTest {
    ...
    public static class OverridingSimpleDataTypeHandler extends SimpleDataTypeHandler  {
        @Override
        public IngestHelperInterface getHelper(Type datatype) {
            ...
            fakeSalvagingIngestHelper.setFieldsToSalvage("ISBN", "dueDate", "author", "borrower", "libraryBranch");
    ...
    public void shouldHandleNullRawData() throws IOException, InterruptedException {
        ...
        map.put("ISBN", "0-123-00000-1");
        map.put("dueDate", "20211126");
        map.put("author", "Henry Hope Reed");
        map.put("borrower", "Edward Clark Potter");
        map.put("libraryBranch", "Grand Central");

        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        new ObjectOutputStream(outputStream).writeObject(map);
        record.setRawData(outputStream.toByteArray());
